    ...
    while menu:
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if (event.key == pygame.K_UP and selected == "Calcium") or (
                    event.key == pygame.K_UP and selected == "Vitamin C"
                ):
                    selected = "Vitamin C"
                elif (event.key == pygame.K_UP and selected == "Fibre") or (
                    event.key == pygame.K_DOWN and selected == "Vitamin C"
                ):
                    selected = "Calcium"
                elif (event.key == pygame.K_UP and selected == "Back") or (
                    event.key == pygame.K_DOWN and selected == "Calcium"
                ):
                    selected = "Fibre"
                elif (event.key == pygame.K_DOWN and selected == "Back") or (
                    event.key == pygame.K_DOWN and selected == "Fibre"
                ):
                    selected = "Back"
